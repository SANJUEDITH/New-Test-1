...
sealed class EviMessage {
  ...
  factory EviMessage.decode(String text) {
    ...
    switch (type) {
      ...
      case 'tool_call':
        return ToolCallMessage(json);
      case 'assistant_end':
        // Adding explicit handling for assistant_end
...
class ToolCallMessage extends EviMessage {
  final String name;
  final Map<String, dynamic> parameters;
  final String toolCallId;
  final bool responseRequired;
  
  ToolCallMessage(Map<String, dynamic> json)
      : name = json['name'] ?? '',
        // Handle the case where parameters might be null or not a map
